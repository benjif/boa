#ifndef BOA_INITIALIZERS_H
#define BOA_INITIALIZERS_H
...
vk::ImageCreateInfo image_create_info(vk::Format format, vk::ImageUsageFlags usage, vk::Extent3D extent);
vk::ImageViewCreateInfo image_view_create_info(vk::Format format, vk::Image image, vk::ImageAspectFlags aspect);
